...
int main(void) {
    ...
    printf("        body { font-family: 'Noto Sans KR', sans-serif; background-color: #f0f0f0; color: #333; line-height: 1.6; margin: 0; padding: 40px 20px; display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 100vh; text-align: center; }\n");
    ...
    printf("        .footer-info { margin-top: 40px; padding: 20px; background-color: #f0f0f0; border-top: 1px solid #ddd; color: #666; font-size: 0.9em; }\n");
    ...
    printf("        pre { background-color: #333; color: #f0f0f0; padding: 10px; border-radius: 5px; overflow-x: auto; text-align: left; }\n");
    ...
    printf("            height: 100%%;\n");
    printf("        }\n");
    printf("        .main-content-wrapper { display: flex; flex-direction: row; justify-content: center; align-items: flex-start; gap: 30px; max-width: 1200px; margin: 0 auto; }\n");
    printf("        .main-content { flex-grow: 1; }\n");
    ...
    printf("        #donation-result { margin-top: 15px; padding: 15px; background-color: #f5f5f5; border: 1px solid #ddd; border-radius: 8px; }\n");
    printf("        #location-result { margin-top: 15px; padding: 15px; background-color: #f5f5f5; border: 1px solid #ddd; border-radius: 8px; }\n");
    ...
    // 메인 컨텐츠와 방문자 카운터를 감싸는 wrapper 시작
    printf("    <div class=\"main-content-wrapper\">\n");
    ...
    printf("            var imageUrl = 'http://125.251.58.80:8090/test.mpjpeg';\n");
    printf("            if (liveImage) {\n");
    ...
    printf("            var audioUrl = 'http://125.251.58.80:8090/test.wav';\n");
    printf("            if (liveAudio) {\n");
